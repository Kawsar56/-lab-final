...
int main()
{
    ...
    Student *students[4]=
    {
       new Student("Atik Rahman","21-03-95",11508016,10,problem_1,true),
       new Student("Kawsar Ahmed","17-01-95",11508029,20,problem_2,false),
       new Student("Mehedi Rahman","11-12-96",11508042,22,problem_3,true),
       new Student("Mosiur Rahman","14-09-95",11508001,30,problem_4,false)
    };
